...
metadata {
	definition (name: "Custom Car Indicator - Cars - Male", namespace: "Cobra", author: "SmartThings") {
		capability "Actuator"
	...
	tiles {
        ...
        standardTile("car2", "device.door", inactiveLabel: false, decoration: "flat") {
			state "default", label:"Mercedes", action:"car2", icon:"st.People.people8"
		}
        standardTile("car1", "device.door", inactiveLabel: false, decoration: "flat") {
			state "default", label:"Alfa", action:"car1", icon:"st.People.people8"
		}
	standardTile("close", "device.door", inactiveLabel: false, decoration: "flat") {
			state "default", label:"Rexton", action:"door control.close", icon:"st.People.people8"
		}
