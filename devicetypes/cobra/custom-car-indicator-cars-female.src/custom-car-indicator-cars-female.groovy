...
metadata {
	...
	tiles {
		standardTile("toggle", "device.door", inactiveLabel: true, width: 3, height: 3) {
			...
			state("opening", label:"Not in Car", icon:"st.People.people2", backgroundColor:"#00A0DC")
			state("closing", label:"Rexton", icon:"st.Transportation.transportation8", backgroundColor:"#010101")
			
		}
		standardTile("open", "device.door", inactiveLabel: false, decoration: "flat") {
			state "default", label:"Not in Car", action:"door control.open", icon:"st.People.people2"
		}
