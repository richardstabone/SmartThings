...
preferences {
    ...
    paragraph "V1.1.0"
     paragraph image:  "https://raw.githubusercontent.com/cobravmax/SmartThings/master/icons/cobra3.png",
        ...
        input "speaker1", "capability.musicPlayer", title: "Choose a speaker (Optional)", required: false, multiple: true, submitOnChange:true
        if(speaker1){
...
LOGDEBUG( "checkNow -  Power is: $state.meterValue")
    ...
    if(!speaker1){
 LOGINFO("No speaker configured - Switching on")
 if(switch1 != null){
 	switch1.on()
	 }
     }
