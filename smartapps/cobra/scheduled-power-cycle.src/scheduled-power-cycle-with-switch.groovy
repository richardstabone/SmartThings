 ...
 *  Power Cycle
 * 
 *  V1.4 - added ability to power cycle when switch turned on 
...
log.info "Control switch has turned on... Cycling switch..."
switchOff()
log.info " Control switch turning back off agin in 10 seconds"
runIn(10,turnSwitchOff)
	}
}

def turnSwitchOff(){
log.info "Turning control switch off again..."
rebootSwitch.off()
